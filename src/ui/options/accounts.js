...
define((require) => {
	...
	async function fillAccountContainer(scrobbler) {
		const elementId = getAccountViewId(scrobbler);
		const accountBody = document.getElementById(elementId);
